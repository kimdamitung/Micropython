...
class OLED_096(object):
    """
        Base class controlling OLED 0.96 inch communicate I2C 
    Returns:
    ...
    _VCOM_DESEL      = 0xdb
    _CHARGE_PUMP     = 0x8d
    def __init__(self, width: int, height: int, i2c: I2C, address: hex  = 0x3c, vcc: bool = False):
        """_summary_
        ...
        Args:
            ...
            address (hex, optional): address i2c of the oled 0.96 inch. Defaults to 0x3c.
            vcc (bool, optional): Power optional. Defaults to False.
        """
        self.width = width
        self.height = height
        self.vcc = vcc
